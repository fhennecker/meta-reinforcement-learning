...
action.
\todo{settings (hyperparameters, gamma,...)}
...
the final reward distributions in the single and dual episode situations. The
agent played every permutation of the training set for 10 trials, playing 180
trials in total. Although the difference is slight, and seeing that the number
